...
class Users
{
    ...
    function registerUserAccount($username, $email, $password)
    {
        ...
        try
		{
			...
			if($row['numrows'] > 0)
            {
                $result = ['response' => false, 'message' => 'Email already taken, Login into account'];
			}
			else
            {
                ...
                $message = "
                    ...
                    <a href='https://annibelcollection.com/activate.php?code=".$code."&user=".$userid."'>Activate Account</a>
                ...
                try
                {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = 'admin@annibelcollection.com';
                    //SMTP password
                    $mail->Password = '6dhFuDbNQh4KeQk';
                    ...
                    //Recipients
                    $mail->setFrom('admin@annibelcollection.com', 'Annibel Jewelry & Collections');
                    //Add a recipient
                    $mail->addAddress($email, $username);
                    //Name is optional
                    //$mail->addAddress('admin@annibelcollection.com');
                    $mail->addReplyTo('admin@annibelcollection.com', 'For any Information');
                    //$mail->addCC('admin@annibelcollection.com');
                    //$mail->addBCC('admin@annibelcollection.com');
                    ...
                    {
                       $result = ['response' => true, 'message' => 'Account created Successful, access your email Inbox or Spam to activate your account'];
                    }
                }
                catch (Exception $eax) 
                {
        ...
        try
		{
			...
			else
            {
                ...
                try
                {
                    ...
                    $result = ['response' => true, 'message' => 'Account created Successful, access your email Inbox or Spam to activate your account', 'usercode' => $userid];
                }
                catch (Exception $eax) 
                {
        ...
        try
		{
			...
			if($row['numrows'] > 0)
            {
				...
				$message = "
					...
					<a href='https://annibelcollection.com/password_reset.php?code=".$code."&user=".$row['id']."'>Reset Password</a>
				";
                ...
                try
                {
                    ...
                    return $result = ['response' => true, 'message' => 'Password reset link sent to your Registered Email Inbox or Spam'];
                }
                catch (Exception $eax) 
                {
                    return $result = ['response' => false, 'message' => 'EMAIL SENDING FAILED. INFO: '.$mail->ErrorInfo];
