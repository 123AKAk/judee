                            ...
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    if (isset($_POST['prod'])) 
                                    {
                                        ...
                                        $product = $productsModel->getProductsBySearch($keyword, "SELECT * FROM products WHERE name LIKE :keyword OR price LIKE :keyword OR description LIKE :keyword OR slug LIKE :keyword");
                                    ...
                                    <div class="container mb-5">
                                        <p>Sorry invalid Link, Click <a href="index.php">here</a> to redirect to <a href="index.php">Home page</p>
                                    </div>
                                     <?php
                                        }
                                    ?>
