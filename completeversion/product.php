                                    ...
                                    <div class="product-details-des">
                                        ...
                                        <div class="quantity-cart-box d-flex align-items-center">
                                            ...
                                            <div class="quantity" id="reloaddiv">
                                                <div class="pro-qty">
                                                    <span class="dec qtybtn" onclick="docart('<?php echo $sharedComponentsModel->protect($productid); ?>', 'updateCartMinus', '<?php echo $ana ?>')">-</span>
                                                    ...
                                                    <input id="quantityinput" type="text" value=" <?php
                                                        ...
                                                        if(isset($_SESSION["cart_item"]))
                                                        {
                                                            ...
                                                            {
                                                                if($decryptedId == $v["id"])
                                                                    $ana = $_SESSION["cart_item"][$k]["quantity"];
                                                            }
                                                            if($ana > 1)
                                                            {
                                                                echo $ana;
                                                    ...
                                                    <span class="inc qtybtn" onclick="docart('<?php echo $sharedComponentsModel->protect($productid); ?>', 'updateCartAdd', '<?php echo $ana ?>')">+</span>
                                                </div>
                                            </div>
                                            <div class="action_link">
                                                <?php
                                            		...
                                            		<?php	    
                                            			...
                                            			{
                                    			    ?>
                                            		    <a class="btn btn-cart2" style="background:black;" href="javascript:void(0)" onclick="docart('<?php echo $productid; ?>', 'addCart', 99)">Added to cart</a>
                                            		<?php
                                        				}
                                        				else
                                        				{
                                    				...
                                    				{
                                			        ?>
                                        		    <a class="btn btn-cart" href="javascript:void(0)" onclick="docart('<?php echo $productid; ?>', 'addCart', 99)">Add to cart</a>
                                        		    <?php	    
                                    				}
                                                    ?>
                                            </div>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                ...
                                                <?php
                                                    if(!empty($_SESSION["cart_item"])) 
                                            		{
                                            		    $decryptedId = $sharedComponentsModel->unprotect($productid);
                                            		    $check = 0;
                                            			foreach($_SESSION["cart_item"] as $k => $v) 
                                            			{
                                            				if($decryptedId == $v["id"])
                                            		...
                                            		<?php	    
                                            			...
                                            			{
                                    			    ?>
                                            		    <a class="btn btn-cart" style="background:black; color:white;" href="javascript:void(0)" onclick="docart('<?php echo $productid; ?>', 'addCart', 99)">Added to cart</a>
                                            		<?php
                                        				}
                                        				else
                                        				{
